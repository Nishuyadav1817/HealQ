 ...
 * by the doctor header's notification bell; useQueueLiveUpdates remains
 * the source of truth for the doctor/date room subscription that
 * actually drives the board's refetches. */
