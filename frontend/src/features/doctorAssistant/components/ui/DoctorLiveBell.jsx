 ...
 * NotificationsBell, which is backed by real toast events) — so rather
 * than invent unread counts or fake alerts, this shows the one real-time
 * signal this panel already has: whether the shared socket connection
 * (see useSocketConnection) is currently able to stream queue updates.
 * Honest about what it is, still gives the header its bell affordance.
 * Same approach as Reception's ReceptionLiveBell.
 */
const DoctorLiveBell = ({ isConnected }) => (
  <span
